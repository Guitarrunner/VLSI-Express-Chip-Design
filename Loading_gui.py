...
background_image=PhotoImage(file = 'Background/GREEN.png')
background_label = Label(master=w, image=background_image)
...
'''
a='#249794'
Frame(w,width=0,height=0,bg=a).place(x=0,y=0)  #249794
